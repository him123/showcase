...
class StipePaymentPage extends StatefulWidget {
  @override
  _StipePaymentPageState createState() => new _StipePaymentPageState();
}

class _StipePaymentPageState extends State<StipePaymentPage> {
  Token _paymentToken;
  PaymentMethod _paymentMethod;
  String _error;
  final String _currentSecret = 'src_client_secret_jhec1MMEcCCaHnfmJrwJbDjV'; //set this yourself, e.g using curl
...
//
  final CreditCard testCard = CreditCard(
    ...
    expMonth: 12,
    expYear: 21,
    name: 'Himanshu dhakecha',
    addressCity: 'Ahmedabad',
    addressCountry: 'India',
    addressLine1: 'B-105, Smarana Appartment',
    addressLine2: 'Bakeri city',
  ...
  initState() {
    ...
    StripePayment.setOptions(
        StripeOptions(publishableKey: "pk_test_xGilOGTNy1RXHexnc5YHHSgN00azMzD2Nc", merchantId: "Test", androidPayMode: 'test'));
  }
...
//        ],
      ...
      ListView(
        ...
        children: <Widget>[
            ...
            onPressed: () {
              StripePayment.paymentRequestWithCardForm(CardFormPaymentRequest()).then((paymentMethod) {
                ...
                setState(() {
                  ...
                  print('Payment method ${_paymentMethod.card.name}');
          ...
          RaisedButton(
            ...
            onPressed: () {
              StripePayment.createTokenWithCard(
                ...
                setState(() {
                  _paymentToken = token;
                  print('Payment method -- ${_paymentToken.tokenId}');
                });
              }).catchError(setError);
            },
          ),
          ...
          Divider(),
          RaisedButton(
            child: Text("Confirm Payment Intent - test"),
