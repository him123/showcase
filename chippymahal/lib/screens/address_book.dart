...
//  }
      ...
      child: Scaffold(
        ...
        body: Column(
          children: <Widget>[
            ...
            Container(
              child: Text(
                isEmpty?'Please add address':'Select address by tapping on it.',
                style: TextStyle(fontWeight: FontWeight.w600),
              ),
            ),
            isEmpty? Text(''): Expanded(
              child: ListView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  ...
                  return InkWell(
                    ...
                    child: Card(
                      color:
                          item.isSelected == '1' ? kColorBGPink : Colors.white,
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            Text('${item.apt_suite_floor}, ${item.address}'),
                            SizedBox(
                              height: 5.0,
                            ),
                            Text(
  ...
  Future<List<Address>> getAddress(String post) async {
    ...
    print('API url: $post');
    var response = await http.get(post, headers: {"token": tokenKey});
